...
<body>
    ...
    <section class="product-showcase">
        <div class="hero-text">
            <h1>Ayam Goreng <span style="color: var(--main-color);">JOSSS</span></h1>
           
        </div>

        <div class="product-carousel">
            <div class="product-item active" data-index="0">
                <img src="{{ asset('gambar/icecoffemilk.jpg') }}" alt="Ayam Original Crispy" class="product-image">
                <div class="product-info">
                    <div class="product-name">Ice Coffe Milk</div>
                    <div class="product-price">Rp 9.000</div>
                </div>
            </div>
            <div class="product-item next" data-index="1">
                <img src="{{ asset('gambar/fruitatian.jpg') }}" alt="Ayam Spicy Hot" class="product-image">
                <div class="product-info">
                    <div class="product-name">Fruitarian</div>
                    <div class="product-price">Rp 0.000</div>
                </div>
            </div>
            <div class="product-item" data-index="2">
                <img src="{{ asset('gambar/fireburgerbeef.jpg') }}" alt="Paket Keluarga" class="product-image">
                <div class="product-info">
                    <div class="product-name">Fire Burger Beef</div>
...
<section class="featured-section">
    ...
    <section class="testimonials-section">
        <h2 class="section-title">Apa Kata Pelanggan Tercinta Kami</h2>
        <p class="section-subtitle">Pengalaman yang luar biasa dari pelanggan setia kami yang telah merasakan kenikmatan Ayam Goreng yang super Lezat.</p>

        <div class="testimonials-container">
            <div class="testimonial active" data-index="0">
                <p class="testimonial-content">"Ayam goreng paling enak dan paling josss yang pernah saya coba! Bumbu meresap sampai ke dalam dan rasanya benar-benar lezat. Sudah jadi langganan keluarga kami."</p>
                <div class="testimonial-author">
                    <div class="author-avatar" style="background-color: #ddd;"></div>
                    <div class="author-info">
                        <div class="author-name">Ahmad Surya</div>
                        <div class="author-title">Pelanggan</div>
                    </div>
                </div>
            </div>

            <div class="testimonial" data-index="1">
                <p class="testimonial-content">"Saya sangat suka dengan burger mereka. Porsinya pas, dagingnya enak, dan pelayanannya ramah. Harga juga sangat ramah kantong untuk kualitas seperti ini!"</p>
                <div class="testimonial-author">
                    <div class="author-avatar" style="background-color: #ddd;"></div>
                    <div class="author-info">
                        <div class="author-name">Susi Fatimah</div>
                        <div class="author-title">Pelanggan</div>
                    </div>
                </div>
            </div>
            ...
            <div class="testimonial" data-index="2">
                <p class="testimonial-content">"Sebagai pecinta makanan pedas, ayam spicy hot mereka adalah favorit saya! Tingkat kepedasannya pas dan tetap bisa menikmati rasa rempah khasnya. sangat direkomendasikan banget!"</p>
                <div class="testimonial-author">
                    <div class="author-avatar" style="background-color: #ddd;"></div>
                    <div class="author-info">
                        <div class="author-name">Hasyam Wijaya</div>
                        <div class="author-title">Pelanggan</div>
                    </div>
                </div>
            </div>
    ...
    <section class="cta-section">
        <h2 class="cta-title">Ayo Dapatkan Promo Spesial!</h2>
        <p class="cta-text">Daftar sekarang dan dapatkan promo spesial untuk pemesanan pertama Anda.</p>
        <form class="cta-form">
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-column">
                <h3>Ayam Goreng JOSSSS</h3>
                <p>Ayam Goreng dengan Kualitas Terbaik yang Menyajikan menu rasa Bintang 5</p>
            ...
            <div class="footer-column">
                <h3>Hubungi Kami</h3>
                <p>Jl. Raya Ayam Goreng No. 25</p>
                <p>Kota Sidoarjo, 2508</p>
                <p>info@ayamgorengjoss.com</p>
                <p>+62 8123 4567 890</p>
            </div>
        </div>
        <div class="copyright">
            <p>© 2025 Ayam Goreng JOSS.</p>
        </div>
    </footer>
