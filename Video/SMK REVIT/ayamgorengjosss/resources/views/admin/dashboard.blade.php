                    ...
                    <div class="section-body">
                        <table class="orders-table">
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr>
                                        <td colspan="6" style="text-align: center; padding: 20px; color: #888;">Tidak ada pesanan terbaru.</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                ...
                <div class="section-card">
                    ...
                    <div class="section-body">
                        <ul class="activity-timeline">
                            ...
                            @else
                                <li class="timeline-item">
                                    <div class="timeline-content" style="color: #888;">Tidak ada aktivitas terbaru.</div>
                                </li>
                            @endif
                        </ul>
                    </div>
